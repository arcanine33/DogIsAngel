 ...
 */
public class EVPostAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public EVPostAdapter(Context context, ArrayList<ProCardViewObject> resources) {
        owner = (MyPageEVProActivity) context;
