 ...
 */
public class JoinDetailAdapter extends PagerAdapter {
    ...
    public JoinDetailAdapter(Context context) {
        ...
        proJoinDetailActivity = (ProJoinDetailActivity) context;
    }
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (inflater != null) {
            ...
            Glide.with(proJoinDetailActivity).load(items.get(position)).into(imageView);
            Log.e("이미지가 배치되었는지 보자꾸나", items.get(position));
            Log.e("이미지가 배치되었는지 보자꾸나", ""+imageView);
