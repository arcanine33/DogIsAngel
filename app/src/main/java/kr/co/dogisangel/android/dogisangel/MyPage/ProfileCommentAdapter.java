...
public class ProfileCommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    ProfileActivity proProfileActivity;


    public ProfileCommentAdapter(ProfileActivity context, ArrayList<CommentObject> resources){
        this.commentObjects = resources;
        this.proProfileActivity = context;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)){
            ...
            case PRO_COMMENT_VIEW:
                ...
                Glide.with(proProfileActivity).load(commentObject.profile_img).into(proCommentViewHolder.pro_profile_img);
                Glide.with(proProfileActivity).load(commentObject.grade_img).into(proCommentViewHolder.grade_img);
            ...
            case HUMAN_COMMENT_VIEW:
                ...
                Glide.with(proProfileActivity).load(commentObject.profile_img).into(humanCommentViewHolder.human_profile_img);
