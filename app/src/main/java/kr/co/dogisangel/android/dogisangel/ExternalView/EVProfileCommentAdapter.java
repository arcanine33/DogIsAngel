 ...
 */
public class EVProfileCommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    MyPageEVProActivity owner;


    public EVProfileCommentAdapter(MyPageEVProActivity context, ArrayList<CommentObject> resources) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            ...
            case PRO_COMMENT_VIEW:
                ...
                Glide.with(owner).load(commentObject.profile_img).into(proCommentViewHolder.pro_profile_img);
                Glide.with(owner).load(commentObject.grade_img).into(proCommentViewHolder.grade_img);
            ...
            case HUMAN_COMMENT_VIEW:
                ...
                Glide.with(owner).load(commentObject.profile_img).into(humanCommentViewHolder.human_profile_img);
