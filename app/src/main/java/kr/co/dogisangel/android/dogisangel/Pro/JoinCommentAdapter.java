 ...
 */
public class JoinCommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    ProJoinDetailActivity proJoinDetailActivity;


    public JoinCommentAdapter(ProJoinDetailActivity context, ArrayList<CommentObject> resources) {
        this.commentObjects = resources;
        this.proJoinDetailActivity = context;
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)) {
            ...
            case PRO_COMMENT_VIEW:
                ...
                Glide.with(proJoinDetailActivity).load(commentObject.profile_img).into(proCommentViewHolder.pro_profile_img);
                Glide.with(proJoinDetailActivity).load(commentObject.grade_img).into(proCommentViewHolder.grade_img);
            ...
            case HUMAN_COMMENT_VIEW:
                ...
                Glide.with(proJoinDetailActivity).load(commentObject.profile_img).into(humanCommentViewHolder.human_profile_img);
    ...
    public int getItemCount() {
        Log.e("공동훈련 댓글 수 : ", ""+commentObjects.size());
