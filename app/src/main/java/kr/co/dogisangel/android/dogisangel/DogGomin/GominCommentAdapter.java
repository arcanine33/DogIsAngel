...
public class GominCommentAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public GominCommentAdapter(GominDetailActivity context, ArrayList<CommentObject> resources){
        this.commentObjects = resources;
        this.gominDetailActivity = context;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        switch (getItemViewType(position)){
            ...
            case PRO_COMMENT_VIEW:
                ...
                Glide.with(gominDetailActivity).load(commentObject.profile_img).into(proCommentViewHolder.pro_profile_img);
                Glide.with(gominDetailActivity).load(commentObject.grade_img).into(proCommentViewHolder.grade_img);
            ...
            case HUMAN_COMMENT_VIEW:
                ...
                Glide.with(gominDetailActivity).load(commentObject.profile_img).into(humanCommentViewHolder.human_profile_img);
