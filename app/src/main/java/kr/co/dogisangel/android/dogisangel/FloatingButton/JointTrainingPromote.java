...
public class JointTrainingPromote extends Fragment {
    ...
    private EditText pro_write_title, training_area, number, month, money_original, money, pro_detail;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.writing_joint_training_promote, container, false);
        ...
        final ToggleButton joint_search_03_basictraining = (ToggleButton) view.findViewById(R.id.joint_search_03_basictraining);
        final ToggleButton joint_search_03_pottytraining = (ToggleButton) view.findViewById(R.id.joint_search_03_pottytraining);
        final ToggleButton joint_search_03_playtraining = (ToggleButton) view.findViewById(R.id.joint_search_03_playtraining);
        final ToggleButton joint_search_03_sociability = (ToggleButton) view.findViewById(R.id.joint_search_03_sociability);
        final ToggleButton joint_search_03_bitingdog = (ToggleButton) view.findViewById(R.id.joint_search_03_bitingdog);
        final ToggleButton joint_search_03_barkingdog = (ToggleButton) view.findViewById(R.id.joint_search_03_barkingdog);
        final ToggleButton joint_search_03_eatdung = (ToggleButton) view.findViewById(R.id.joint_search_03_eatdung);
        final ToggleButton joint_search_03_competition = (ToggleButton) view.findViewById(R.id.joint_search_03_competition);
        final ToggleButton joint_search_03_guidance = (ToggleButton) view.findViewById(R.id.joint_search_03_guidance);

        pro_write_title = (EditText) view.findViewById(R.id.pro_write_title);
        pro_detail = (EditText) view.findViewById(R.id.pro_detail);
        number = (EditText) view.findViewById(R.id.number);
        month = (EditText) view.findViewById(R.id.month);
        money_original = (EditText) view.findViewById(R.id.money_original);
        money = (EditText) view.findViewById(R.id.money);
        pro_file_upload_btn = (Button) view.findViewById(R.id.pro_file_upload_btn);
        training_area = (EditText) view.findViewById(R.id.pro_write_area);

        pro_detail.setOnTouchListener(new View.OnTouchListener() {
            @Override
            public boolean onTouch(View v, MotionEvent event) {
                if (v.getId() == R.id.pro_detail) {
        ...
        dogsize_radio_group = (RadioGroup) view.findViewById(R.id.join_dogsize_radioGroup);
        ...
        pro_file_upload_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (pro_write_title.getText().toString().length() == 0) {
                    Toast.makeText(getActivity(), "제목을 입력해주세요!", Toast.LENGTH_SHORT).show();
                    pro_write_title.requestFocus();
                ...
                } else if (training_area.getText().toString().length() == 0) {
                    Toast.makeText(getActivity(), "훈련할 장소를 입력해주세요!", Toast.LENGTH_SHORT).show();
                    training_area.requestFocus();
                    ...
                    Toast.makeText(getActivity(), "훈련 기간을 입력해주세요!", Toast.LENGTH_SHORT).show();
                    month.requestFocus();
                } else if (money_original.getText().toString().length() == 0) {
                    Toast.makeText(getActivity(), "원가를 입력해주세요!", Toast.LENGTH_SHORT).show();
                    money_original.requestFocus();
                } else if (money.getText().toString().length() == 0) {
                    Toast.makeText(getActivity(), "할인가격을 입력해주세요!", Toast.LENGTH_SHORT).show();
                    money.requestFocus();
                } else if (pro_detail.getText().toString().length() == 0) {
                    Toast.makeText(getActivity(), "내용을 입력해주세요!", Toast.LENGTH_SHORT).show();
                    pro_detail.requestFocus();
                } else {
                    pro_file_upload_btn.setEnabled(false);

                    String title = pro_write_title.getText().toString().trim();
                    String content = pro_detail.getText().toString().trim();
                    String query3 = number.getText().toString().trim();
                    String query4 = month.getText().toString().trim();
                    String query5 = money_original.getText().toString().trim();
                    String query6 = money.getText().toString().trim();
                    String query7 = training_area.getText().toString().trim();
                    ...
                    if (joint_search_03_basictraining.isChecked()) {
                        basictraining = "기본훈련";
                        toggleArrayList.add(basictraining);
                    }
                    if (joint_search_03_pottytraining.isChecked()) {
                        pottytraining = "배변훈련";
                        toggleArrayList.add(pottytraining);
                    }
                    if (joint_search_03_barkingdog.isChecked()) {
                        barkingdog = "짖는 개 훈련";
                        toggleArrayList.add(barkingdog);
                    }
                    if (joint_search_03_bitingdog.isChecked()) {
                        bitingdog = "무는 개 훈련";
                        toggleArrayList.add(bitingdog);
                    }
                    if (joint_search_03_playtraining.isChecked()) {
                        playtraining = "놀이훈련";
                        toggleArrayList.add(playtraining);
                    }
                    if (joint_search_03_sociability.isChecked()) {
                        sociability = "사회성";
                        toggleArrayList.add(sociability);
                    }
                    if (joint_search_03_eatdung.isChecked()) {
                        eatdung = "식분증";
                        toggleArrayList.add(eatdung);
                    }
                    if (joint_search_03_competition.isChecked()) {
                        competition = "대회 훈련";
                        toggleArrayList.add(competition);
                    }
                    if (joint_search_03_guidance.isChecked()) {
                        guidance = "안내견 ";
                    ...
                    new FileUpLoadAsyncTask(title, content, query3, query4, query5, query6, content_type,
                            query7, dog_size_check).execute(upLoadfiles);
        ...
        joint_search_03_basictraining.setText(null);
        joint_search_03_basictraining.setTextOn(null);
        joint_search_03_basictraining.setTextOff(null);

        final int image[] = {
                R.drawable.search_03_basictraining,
                R.drawable.search_03_basictraining_tap,
        };
        joint_search_03_basictraining.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (joint_search_03_basictraining.isChecked()) {
                    joint_search_03_basictraining.setBackgroundResource(image[1]);
                } else {
                    joint_search_03_basictraining.setBackgroundResource(image[0]);
        ...
        joint_search_03_pottytraining.setText(null);
        joint_search_03_pottytraining.setTextOn(null);
        joint_search_03_pottytraining.setTextOff(null);
        ...
        joint_search_03_pottytraining.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (joint_search_03_pottytraining.isChecked()) {
                    joint_search_03_pottytraining.setBackgroundResource(image1[1]);

                } else {
                    joint_search_03_pottytraining.setBackgroundResource(image1[0]);
                }
            }
        });


        joint_search_03_playtraining.setText(null);
        joint_search_03_playtraining.setTextOn(null);
        joint_search_03_playtraining.setTextOff(null);
        ...
        joint_search_03_playtraining.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (joint_search_03_playtraining.isChecked()) {
                    joint_search_03_playtraining.setBackgroundResource(image2[1]);

                } else {
                    joint_search_03_playtraining.setBackgroundResource(image2[0]);
                }
            }
        });

        joint_search_03_sociability.setText(null);
        joint_search_03_sociability.setTextOn(null);
        joint_search_03_sociability.setTextOff(null);
        ...
        joint_search_03_sociability.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (joint_search_03_sociability.isChecked()) {
                    joint_search_03_sociability.setBackgroundResource(image3[1]);

                } else {
                    joint_search_03_sociability.setBackgroundResource(image3[0]);
                }
            }
        });

        joint_search_03_bitingdog.setText(null);
        joint_search_03_bitingdog.setTextOn(null);
        joint_search_03_bitingdog.setTextOff(null);
        ...
        joint_search_03_bitingdog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (joint_search_03_bitingdog.isChecked()) {
                    joint_search_03_bitingdog.setBackgroundResource(image4[1]);
                } else {
                    joint_search_03_bitingdog.setBackgroundResource(image4[0]);
                }
            }
        });

        joint_search_03_barkingdog.setText(null);
        joint_search_03_barkingdog.setTextOn(null);
        joint_search_03_barkingdog.setTextOff(null);
        ...
        joint_search_03_barkingdog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (joint_search_03_barkingdog.isChecked()) {
                    joint_search_03_barkingdog.setBackgroundResource(image5[1]);
                } else {
                    joint_search_03_barkingdog.setBackgroundResource(image5[0]);
                }
            }
        });

        joint_search_03_eatdung.setText(null);
        joint_search_03_eatdung.setTextOn(null);
        joint_search_03_eatdung.setTextOff(null);
        ...
        joint_search_03_eatdung.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (joint_search_03_eatdung.isChecked()) {
                    joint_search_03_eatdung.setBackgroundResource(image6[1]);
                } else {
                    joint_search_03_eatdung.setBackgroundResource(image6[0]);
                }
            }
        });


        joint_search_03_competition.setText(null);
        joint_search_03_competition.setTextOn(null);
        joint_search_03_competition.setTextOff(null);
        ...
        joint_search_03_competition.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (joint_search_03_competition.isChecked()) {
                    joint_search_03_competition.setBackgroundResource(image7[1]);
                } else {
                    joint_search_03_competition.setBackgroundResource(image7[0]);
                }
            }
        });


        joint_search_03_guidance.setText(null);
        joint_search_03_guidance.setTextOn(null);
        joint_search_03_guidance.setTextOff(null);
        ...
        joint_search_03_guidance.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (joint_search_03_guidance.isChecked()) {
                    joint_search_03_guidance.setBackgroundResource(image8[1]);
                } else {
                    joint_search_03_guidance.setBackgroundResource(image8[0]);
                }
            }
        });
    ...
    private class FileUpLoadAsyncTask extends AsyncTask<ArrayList<UpLoadValueObject>, Void, String> {
        ...
        private String query3; //보낼쿼리
        private String query4; //보낼쿼리
        private String query5; //보낼쿼리
        private String query6; //보낼쿼리
        private String query7;
        private String content_type;
        private String dog_size_check;//보낼쿼리
       // NetworkDialog networkDialog = new NetworkDialog(MyApplication.getMyApplicationContext());


        public FileUpLoadAsyncTask(String title, String content, String query3,
                                   String query4, String query5, String query6, String content_type, String query7, String dog_size_check) {
            this.title = title;
        ...
        protected String doInBackground(ArrayList<UpLoadValueObject>... arrayLists) {
            ...
            try {
                ...
                builder.addFormDataPart("recruit_person", query3);
                builder.addFormDataPart("train_period", query4);
                builder.addFormDataPart("cost", query5);
                builder.addFormDataPart("discount_cost", query6);
                builder.addFormDataPart("train_spot", query7);
