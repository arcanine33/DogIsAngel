...
//                    new FileUpLoadAsyncTask(query1, query2).execute(upLoadfiles);
                    ...
                    Toast.makeText(Pro_changeActivity.this, "업로드할 파일이 없습니다", Toast.LENGTH_SHORT).show();
                }
...
//                builder.addFormDataPart("content", query2);
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.equalsIgnoreCase("success")){
                Toast.makeText(Pro_changeActivity.this, "파일업로드에 성공했습니다", Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(Pro_changeActivity.this, "파일업로드에 실패했습니다", Toast.LENGTH_LONG).show();
            }
