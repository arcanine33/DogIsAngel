 ...
 */
public class ProMyPostAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ProMyPostAdapter(Context context, ArrayList<ProCardViewObject> resources) {
